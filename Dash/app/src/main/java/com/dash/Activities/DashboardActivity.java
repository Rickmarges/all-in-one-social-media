...
public class DashboardActivity extends AppCompatActivity {
    ...
    private void signOut() {
        ...
        try {
            ...
            Log.w(getApplicationContext().toString(), "No views in Trends to delete: " + npe.getMessage());
        }
        ...
        try {
            ...
            Log.w(getApplicationContext().toString(), "No views in Reddit to delete: " + npe.getMessage());
        }
