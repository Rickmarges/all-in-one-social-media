...
public class StreamAPITest extends TwitterTestBase implements StatusListener, ConnectionLifeCycleListener {
    ...
    void testStatusStream() throws Exception {
        ...
        stream.next(this);
        waitForNotification();
        assertEquals("Acho retartado ter que esperar para usar o script de novo, por isso só uso o TwitterRepository Followers, o site da empresa é: http://bit.ly/5tNlDp", status.getText());
        stream.next(this);
        waitForNotification();
    ...
    void testSample() throws Exception {
        ...
        assertNull(status, "ensure that original listener doesn't receive any statuses");
