...
public abstract class HttpClientBase implements HttpClient, Serializable {
    ...
    public HttpClientBase(HttpClientConfiguration conf) {
        ...
        requestHeaders.put("X-TwitterRepository-Client-Version", Version.getVersion());
        requestHeaders.put("X-TwitterRepository-Client-URL", "http://twitter4j.org/en/twitter4j-" + Version.getVersion() + ".xml");
        requestHeaders.put("X-TwitterRepository-Client", "Twitter4J");
