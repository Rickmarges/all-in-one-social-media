 ...
 * In case the TwitterRepository server returned HTTP error code, you can get the HTTP status code using getStatusCode() method.
 *
...
public class TwitterException extends Exception implements TwitterResponse, HttpResponseCode {
     ...
     * @see <a href="https://dev.twitter.com/docs/rate-limiting">Rate Limiting | TwitterRepository Developers</a>
    ...
    private static String getCause(int statusCode) {
        ...
        switch (statusCode) {
            ...
            case INTERNAL_SERVER_ERROR:
                cause = "Something is broken. Please post to the group (https://dev.twitter.com/docs/support) so the TwitterRepository team can investigate.";
                break;
            case BAD_GATEWAY:
                cause = "TwitterRepository is down or being upgraded.";
                break;
            case SERVICE_UNAVAILABLE:
                cause = "The TwitterRepository servers are up, but overloaded with requests. Try again later.";
                break;
            case GATEWAY_TIMEOUT:
                cause = "The TwitterRepository servers are up, but the request couldn't be serviced due to some failure within our stack. Try again later.";
                break;
            default:
                cause = "";
        }
