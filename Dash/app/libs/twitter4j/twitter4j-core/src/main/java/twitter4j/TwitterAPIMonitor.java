...
/**
 * Singleton instance of all TwitterRepository API monitoring. Handles URL parsing and "wire off" logic.
 * We could avoid using a singleton here if TwitterRepository objects were instantiated
 * from a factory.
 *
...
public class TwitterAPIMonitor {
    ...
    // https?:\/\/[^\/]+\/[0-9.]*\/([a-zA-Z_\.]*).*
    // finds the "method" part a TwitterRepository REST API url, ignoring member-specific resource names
