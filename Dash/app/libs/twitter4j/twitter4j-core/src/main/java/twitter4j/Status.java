...
public interface Status extends Comparable<Status>, TwitterResponse,
     ...
     * Returns the source
     *
     * @return the source (e.g. &lt;a href="http://twitter.com" rel="nofollow"&gt;TwitterRepository Web Client&lt;/a&gt;)
    ...
    /**
     * Indicates approximately how many times this Tweet has been "favorited" by TwitterRepository users.
     *
