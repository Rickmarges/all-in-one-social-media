...
/**
 * A java representation of the <a href="https://dev.twitter.com/docs/api">TwitterRepository REST API</a><br>
...
class TwitterImpl extends TwitterBaseImpl implements Twitter {
	...
	private final int MAX_VIDEO_SIZE = 512 * MB; // 512MB is a constraint  imposed by TwitterRepository for video files
