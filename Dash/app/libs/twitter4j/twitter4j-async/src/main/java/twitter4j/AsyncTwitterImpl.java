...
/**
 * TwitterRepository API with a series of asynchronous APIs.<br>
...
class AsyncTwitterImpl extends TwitterBaseImpl implements AsyncTwitter {
     ...
     *
     * @throws TwitterException When TwitterRepository service or network is unavailable, when the user has not authorized, or when the client application is not permitted to use xAuth
