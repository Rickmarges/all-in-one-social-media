...
public interface DirectMessagesResourcesAsync {
     ...
     *
     * @param id int
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/direct_messages/destroy/:id">POST direct_messages/destroy/:id | TwitterRepository Developers</a>
     * @since Twitter4J 2.0.1
     */
     ...
     * @see <a href="https://dev.twitter.com/docs/api/1.1/post/direct_messages/new">POST direct_messages/new | TwitterRepository Developers</a>
